 ...
 * based on bk2k/bootstrap-package.
 *
...
use Pfadfinden\BdpTemplate\Utility\SvgUtility;
...
class InlineSvgViewHelper extends AbstractViewHelper
{
    ...
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument('aria-hidden', 'boolean', 'Area', false);
        $this->registerArgument('aria-label', 'string', 'Area label of the svg.', false);
    }
    ...
    public function render(): string {
        ...
        $ariaHidden = isset($this->arguments['aria-hidden']) ? (bool) $this->arguments['aria-hidden'] : null;
        $ariaLabel = isset($this->arguments['aria-label']) ? (string) $this->arguments['aria-label'] : null;

        return SvgUtility::getInlineSvg($src, $image, $width, $height, $class, $ariaHidden, $ariaLabel);
    }
}
